...
public class atraccio extends Serializable {
	...
	public atraccio(int id, String nom, String url_foto, int codi_estat, float temps_espera_minuts, String descripcio_html, int capacitat, int alçada_minima, int alçada_minima_acompanyant)
	{
		this.id = id;
		this.nom = nom;
