...
namespace DBBasic
{
    public class info_atraccio : Serializable
    {
        ...
        public info_atraccio(int id, string nom, string url_foto, int codi_estat, float temps_espera_minuts, string descripcio_html, int capacitat, int alçada_minima, int alçada_minima_acompanyant)
        {
            this.id = id;
            this.nom = nom;
