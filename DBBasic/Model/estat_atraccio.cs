...
namespace DBBasic
{
    ...
    public class estat_atraccio
    {
        ...
        public estat_atraccio(int id, string nom, string url_foto, string nom_parc, string url_foto_parc, int codi_estat, int temps_espera_minuts, string descripcio_html, int capacitat, int alçada_minima, int alçada_minima_acompanyant)
        {
            this.id = id;
            this.nom = nom;
